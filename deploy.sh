...
GITHUB_ACCESS_TOKEN="c8636216ab9c31564b31bc818988599a682df3df"

# The slug of your WordPress.org plugin
PLUGIN_SLUG="edd-terms-per-product"

# GITHUB user who owns the repo
GITHUB_REPO_OWNER="easydigitaldownloads"

# GITHUB Repository name
GITHUB_REPO_NAME="edd-terms-per-product"
